      ...
      <div cntFocusTrap (escape)="cancel()"
        ...
        <div class="flex justify-end gap-2 mt-5">
          ...
          <button type="button" (click)="save()" [disabled]="!value.trim()"
            class="inline-flex items-center gap-1.5 px-5 py-2 rounded-full bg-trinidad text-white text-[0.65rem] uppercase tracking-[0.12em] font-button font-bold hover:opacity-95 disabled:opacity-40 disabled:cursor-not-allowed shadow-[0_6px_16px_rgba(227,83,13,0.25)]">
